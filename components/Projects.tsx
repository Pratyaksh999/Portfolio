...
const projects = [
  {
    ...
    description: "Production-grade AI support platform with FastAPI & LLaMA 3.1, Shopify live catalog integration (100+ products), in-chat checkout, multi-step ticket state machine, and automated email escalation. 60% improvement in support resolution efficiency.",
    tags: ["FastAPI", "LLaMA 3.1", "Ollama", "Shopify API", "Vanilla JS"],
    github: "https://github.com/Pratyaksh999/AI-Powered-Chatbot",
    featured: true,
    emoji: "🤖",
    color: "#00dc82",
    metrics: ["60% faster resolution", "100+ products synced", "Single-script embed"],
  },
  {
  ...
  },
  {
    ...
    description: "Deep Learning + OpenCV system with spatial & temporal feature engineering, improving detection accuracy by 20–30% in production.",
    tags: ["Deep Learning", "OpenCV", "Python", "CV"],
  ...
  },
  {
    ...
    description: "ML model for classifying fake vs real news using TF-IDF, word embeddings, and ensemble classifiers.",
    tags: ["NLP", "Scikit-learn", "NLTK", "Python"],
    github: "https://github.com/Pratyaksh999/Fake-News-Prediction",
    featured: false,
    emoji: "📰",
    color: "#06b6d4",
